...
int main() {
    ...
    //lined up from a1 - an
    //wants to switch from b1-bn
    //find most efficient way to move from a -> b
    ...
    for(int i = 0; i < n; i++)
    {
        int e; cin >> e;
        ord.eb(indx[e]);
        plc[indx[e]] = i; //connects index of the # in the first arr to its index in the second
    }
    //basically switched all the values into indexes for where they belong
